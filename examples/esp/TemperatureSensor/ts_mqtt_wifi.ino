...
const char *WIFI_SSID = "smart-home-wifi";
const char *WIFI_PASSWORD = "Smart1234";

//MQTT Parameter setzen
const char *MQTT_HOST = "192.168.158.11";
...
void connect() {
  ...
  while (!client.connected()){
    ...
    Serial.print("Versuche MQTT Verbindungsaufbau!");
    ...
    if (mqttClient.connect(MQTT_CLIENT_ID, MQTT_USER, MQTT_PASSWORD)) {
      ...
      Serial.print("MQTT fehlgeschlagen, versuche erneut!");    
      delay(5000);
    }
  }
}
